...
// Lock is an empty method that implements Locker interface to prevent copying
func (rc *RefCount) Lock() {}

// Unlock is an empty method that implements Locker interface to prevent copying
func (rc *RefCount) Unlock() {}
